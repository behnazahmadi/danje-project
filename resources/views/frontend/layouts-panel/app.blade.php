...
<div class="sidebar" id="userProfile">
    <div class="text-center p-4">
        <figure class="avatar avatar-state-success avatar-lg mb-4">
            <img src="{{asset('assets/users/'.auth()->user()->profile_image)}}" class="rounded-circle" alt="image">
        </figure>
...
<!-- begin::navigation -->
@include("frontend.layouts-panel.navigation")
<!-- end::navigation -->

<!-- begin::header -->
@include("frontend.layouts-panel.header")
<!-- end::header -->
...
@yield("script")
@include("frontend.layouts-panel.footer")
