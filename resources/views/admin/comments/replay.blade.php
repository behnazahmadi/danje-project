...
@section("content")
    <main class="main-content">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{route("admin.comments.replay.store",["comment"=>$comment->id])}}" method="post"  class="needs-validation" >
                    @csrf
                    ...
                    <div class="form-row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <textarea  class="form-control" placeholder="متن کامنت" >{{$comment->content}}</textarea>
                        </div>
