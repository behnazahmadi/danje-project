<div class="navigation">
    <div class="navigation-icon-menu">
        <ul>
            ...
            <li class="active" data-toggle="tooltip" title="مدیریت پنل">
                <a href="#managepanel" title="مدیریت پنل">
        ...
        <ul>
            ...
            <form action="{{url("logout")}}" method="post" id="logout_admin">
                @csrf
            </form>
            <li  title="خروج" >
                <a href="" onclick='event.preventDefault();document.getElementById("logout_admin").submit()' >
    ...
    <div class="navigation-menu-body">
        ...
        <ul id="managepanel">
            ...
            <li>
                <a href="{{route("admin.blogs.index")}}">بلاگ</a>
            </li>
            <li>
                <a href="{{route("admin.galleries.index")}}">گالری</a>
            </li>
            <li>
                <a href="{{route("admin.categories.index")}}">دسته بندی</a>
            </li>
            <li>
                <a href="{{route("admin.social_networks.index")}}">شبکه اجتماعی</a>
            </li>
            <li>
                <a href="{{route("admin.comments.index")}}">کامنت</a>
            </li>
            <li>
            ...
            <li>
                <a href="{{route('admin.tickets.index')}}">تیکت</a>
            </li>
            <li>
                <a href="{{route("admin.contacts.index")}}">تماس با ما</a>
            </li>
            <li>
                <a href="chat.html">پروژه / محصولات</a>
            </li>
